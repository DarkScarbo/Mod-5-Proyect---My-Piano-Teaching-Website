        ...
        <div style={{ padding: "1.15em 0em" }}>
          <Segment secondary>
            ...
            <p>
              ...
              living and working in London. I am also a classically trained
              singer (baritone) and a singing teacher.
            </p>
            <p>
            ...
            <p>
              ...
              this with a Masters in Musical Interpretation and Research at VIU
              in Valencia under Eugen Indic and Francisco Escoda Padrón at the
              same time as doing a post-graduate in Contemporary Music at CSMA
              in Zaragoza with Ricardo Descalzo, Nicolás Hodges, Alberto Rosado
              and Yukiko Sugawara.
            </p>
            <p>
              {" "}
            ...
            <p>
              ...
              the student's individual needs, teaching in a clear, supportive
              and friendly way. Most importantly, I try to build my students'
              confidence and ensure that they thoroughly enjoy the classes
              (while of course learning the essential skills to progress)!{" "}
            </p>
            <p>
          ...
          <Segment secondary style={{ marginBottom: "20px" }}>
            ...
            <List bulleted>
              ...
              <List.Item>
                Masters in Contemporary Piano. Conservatorio Superior de Música
