...
const Lessons = props => {
  return (
    ...
    >
      ...
      <p className="p-review">
        I'm a dedicated and passionate teacher with a thorough approach, always
        getting the best out of my students. I adapt to new students with ease,
        teaching in a clear, relaxed, supportive and friendly way. 
      </p>
      <Image
      ...
      />
      <p className="p-review">
        The most important objective of a lesson is that they are fun, engaging,
        and rewarding. I have an individualized approach that focuses on each
        student's strengths and areas for improvement in a highly supportive and
      ...
      <p className="p-review">
        ...
        this entirely, or offer some combination of approach – whatever suits! 
      </p>
      <Image
        style={{ paddingLeft: "1px" }}
