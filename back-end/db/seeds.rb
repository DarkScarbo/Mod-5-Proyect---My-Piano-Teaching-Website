...
message_one = Message.create(text: "Hey Xabi! I need a piano teacher! Are you available", student_id: harriet.id, teacher_id: xabi.id)
message_two = Message.create(text: "Hey Harriet! Yes, I would love to be your piano teacher !", student_id: harriet.id, teacher_id: xabi.id)
