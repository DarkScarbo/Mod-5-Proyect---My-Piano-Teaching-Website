...
harriet_playing_satanic_poem = Video.create(url: "xUWVPuSA1PI", title: "Harriet playing Poeme Satanique Op.36, by Scriabin", description: "Recorded in 2019/07/05", user_id: harriet.id)
fran_playing_cantos_magicos = Video.create(url: "pLKedWPEc-U", title: "Fran playing Cants Magics, by Mompou", description: "Recorded in 2019/06/30", user_id: fran.id)
